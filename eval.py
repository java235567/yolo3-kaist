...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', '-d',    type=str, 
        default='data/kaist.data', help='data definition file')
    parser.add_argument('--config', '-c',  type=str, 
        default='cfg/yolov3_kaist_tc_det.cfg', help='network configuration file')
    parser.add_argument('--weights', '-w', type=str, nargs='+', 
        default=['weights/yolov3_kaist_tc_det_thermal.weights'], help='initial weights file')
